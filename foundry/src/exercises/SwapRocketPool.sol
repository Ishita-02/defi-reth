...
contract SwapRocketPool {
        ...
        returns (uint256 rEthAmount, uint256 fee)
    {
        ...
        ethAmount -= fee;
        uint256 rETHAmount = reth.getRethValue(ethAmount);
        ...
        returns (uint256 ethAmount)
    {
        ...
        uint256 ethAmounts = reth.getEthValue(rEthAmount);
    ...
    function getAvailability() external view returns (bool, uint256) {
        ...
        return(protocolSettings.getDepositEnabled(), depositPool.getMaximumDepositAmount());
    }
